...
.initial-modal__title-accent {
  color: #c900c9;
}

.initial-modal__title-main {
  color: #027500;
}

.initial-modal__description {
  max-width: 580px;
  color: #444234;
